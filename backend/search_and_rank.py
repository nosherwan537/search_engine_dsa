...
def retrieve_document(doc_id, documents_df):
    ...
    try:
        ...
        return f"Document {doc_id}", "Snippet unavailable."

def display_results(results, documents_df):
    for doc_id, score in results:
        title, snippet = retrieve_document(doc_id, documents_df)
